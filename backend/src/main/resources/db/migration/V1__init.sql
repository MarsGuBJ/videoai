...
CREATE INDEX face_events_created_at_idx ON face_events (created_at DESC);
CREATE INDEX face_events_camera_profile_idx ON face_events (camera_id, face_profile_id, created_at DESC);
