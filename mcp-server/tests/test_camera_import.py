...
MANIFEST = Path(__file__).parents[1] / "app" / "data" / "2026-07-29-cameras.csv"
...
def test_discover_device_channels_prefers_isapi_channels_and_rtsp_port():
    responses = {
        ...
        "/ISAPI/Streaming/channels": b"<StreamingChannelList><StreamingChannel><id>101</id><channelName>Main</channelName></StreamingChannel></StreamingChannelList>",
    }
